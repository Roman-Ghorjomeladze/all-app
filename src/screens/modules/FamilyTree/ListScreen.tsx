	...
	return (
		<SafeAreaView style={styles.safeArea}>
			...
			<View style={styles.header}>
				...
				<TouchableOpacity
					onPress={() => navigation.navigate("FamilyTreePerson", { mode: "create", treeId })}
				>
			...
			<Text style={styles.countText}>
				{t("ftPersons", { count: String(filtered.length) })}
			</Text>
			...
			<FlatList
				...
				renderItem={({ item }) => (
					<PersonListItem person={item} onPress={handlePersonPress} />
				)}
				ListEmptyComponent={
