...
type Props = NativeStackScreenProps<LLQuizStackParamList, "LLQuizResult">;
	...
	return (
		<SafeAreaView style={styles.safeArea}>
			<View style={styles.container}>
				...
				<Text style={styles.title}>{t("llResult")}</Text>
				...
				{mistakeCount > 0 && (
					<Text style={styles.mistakeInfo}>
						{t("llMistakesSaved", { count: String(mistakeCount) })}
					</Text>
				)}
				...
				<View style={styles.buttonsContainer}>
					<TouchableOpacity
						...
						activeOpacity={0.8}
					>
						<Text style={styles.playAgainText}>{t("llPlayAgain")}</Text>
					</TouchableOpacity>
				</View>
			</View>
		</SafeAreaView>
